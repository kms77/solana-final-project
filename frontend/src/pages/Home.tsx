                ...
                <div className="container max-w-md px-4 z-10">
                    <div className="flex flex-col items-center space-y-8" style={{ opacity: 1, transform: 'none' }}>
                        ...
                        <div className="w-full max-w-xs mt-8">
                            <button className="whitespace-nowrap rounded-md font-medium h-10 px-4 w-full bg-cyan-500 from-cyan-500 to-blue-5000 text-white hover:from-cyan-500 hover:to-teal-500 transition-all duration-300 py-6 text-lg flex items-center justify-center gap-2">

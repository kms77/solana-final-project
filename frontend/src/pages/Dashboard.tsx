    ...
    return (
        <div className="min-h-screen bg-black text-white p-8">
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-4"> {/* Group Title and Back Button */}
                    <Link to="/" className="text-gray-400 hover:text-white transition-colors">
                        {/* Simple text back button for now, could add an icon */}
                        &larr; Back
                    </Link>
                    ...
                    <div className="bg-zinc-900 p-4 rounded-lg shadow-md w-full space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-zinc-700 p-4 rounded-lg">
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-blue-600 rounded-lg text-xl">
                                        📦
                                    </div>
                                    <div>
                            ...
                            <div className="bg-zinc-700 p-4 rounded-lg">
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-green-600 rounded-lg text-xl">
                                        🟡
                                    </div>
                                    <div>
                                        <p className="text-md text-gray-400">
                            ...
                            <div className="bg-zinc-700 p-4 rounded-lg">
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-purple-600 rounded-lg text-xl">
                                        🎫
                                    </div>
                                    <div>
                                        <p className="text-md text-gray-400">
                                    ...
                                    <Button
                                        className="ml-auto text-md" // Add specific classes if needed
